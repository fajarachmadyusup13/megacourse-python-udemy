...
def update_command():
    backend.update(selected_tupple[0], title_text.get(), author_text.get(), year_text.get(), isbn_text.get())
...
b4 = Button(window, width=12, text="Update selected", command=update_command)
b4.grid(row=5, column=3)

b5 = Button(window, width=12, text="Delete selected", command=delete_command)
